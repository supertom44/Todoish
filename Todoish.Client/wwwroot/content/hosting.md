...
##  [/Todoish.Client](https://github.com/NetCoreTemplates/blazor-wasm/tree/main/Todoish.Client)
...
## [/Todoish](https://github.com/NetCoreTemplates/blazor-wasm/tree/main/Todoish)

The .NET 6 `/Todoish` backend server is required for this App's dynamic functions including the Hello API on the home page
